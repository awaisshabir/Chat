...
namespace Order.Api
{
    public class Program
    {
        ...
        private static void Listener()
        {
            ...
            channel.BasicConsume(queue: "cyclus.order.user",
                autoAck: true,
                consumer: consumer);
        }
        ...
        {
            var contextOptions = new DbContextOptionsBuilder<Order.Api.Data.OrderDbContext>()
                .UseSqlite(@"Data Source=order.db").Options;
            var dbContext = new OrderDbContext(contextOptions);
